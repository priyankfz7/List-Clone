...
function first_carazol() {
  ...
  second_carazol();
// ******************
function third_carazol() {

  const slider = document.querySelector(".carazol3");
  let isDown = false;
  let startX;
  let scrollLeft;
...
third_carazol();
function forth_carazol() {
 
  const slider = document.querySelector(".carazol4");
  let isDown = false;
  let startX;
  let scrollLeft;
...
forth_carazol();
function fifth_carazol() {
 
  const slider = document.querySelector(".carazol5");
  let isDown = false;
  let startX;
  let scrollLeft;
